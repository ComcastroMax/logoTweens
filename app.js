...
(function() {
  this.AnimationShrinkBlurLayer = (function() {
    function AnimationShrinkBlurLayer(layer) {
      this.layer = layer;
      this.makeAnimations();
    }
...
(function() {
  this.AnimationBlurSequence = (function() {
    ...
    AnimationBlurSequence.prototype.makeAnimations = function() {
      this.blurStar = new AnimationShrinkBlurLayer(this.logo.cStar);
      this.blurC = new AnimationShrinkBlurLayer(this.logo.cMid);
      this.blurIn = new AnimationShrinkBlurLayer(this.logo.cIn);
      this.blurOut = new AnimationShrinkBlurLayer(this.logo.cOut);
      return this.blurStar.shrinkBlur.on(Events.AnimationEnd((function(_this) {
        return function() {
          return _this.blurC.start();
        };
      })(this)));
...
(function() {
  var i, len, logo, logoCheating, logoMain, logos, tall;
  ...
  logos = [new LogoLayer, new LogoLayer, new LogoLayer, new LogoLayer, new LogoLayer, new LogoLayer];
  ...
  for (i = 0, len = logos.length; i < len; i++) {
    logo = logos[i];
    logo.start();
    logo.on(Events.MouseOver, (function(_this) {
      return function(event, layer) {
        ...
        return logoMain.start();
      };
    })(this));
    logo.on(Events.MouseOut, (function(_this) {
      return function(event, layer) {
        logoCheating.visible = true;
        return logoMain.stop();
      };
    })(this));
  }
